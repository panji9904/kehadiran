...
<body>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="card shadow">
                            <div class="card-body">
                                <h2 class="card-title text-center">Absensi Pulang</h2>
    ...
    <script>
        ...
        document.querySelector('form').addEventListener('submit', function (e) {
            ...
            xhr.send('id=' + id + '&nama=' + nama + '&jam_pulang=' + jamPulang);
        });
        ...
        // Mengisi input jam_pulang dengan waktu saat ini
        ...
        document.getElementById('jam_pulang').value = currentHour + ':' + currentMinute;
    </script>
</body>
</html>
